...
class CustomGridTransition: NSObject, UIViewControllerAnimatedTransitioning {
    
    let durationExpanding = 0.3
    ...
    /*
     * Method to Add Custom Transition for ModalVC present and dismisal
     */
